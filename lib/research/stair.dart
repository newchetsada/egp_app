...
class stair extends StatefulWidget {
  @override
  _stairState createState() => _stairState();
}

class _stairState extends State<stair> {
      ...
      body: ListView(
        children: [
          ...
          Padding(
            ...
            child: GestureDetector(
                onTap: () {
                  addSheet('ความสูงของอาคารที่ต้องใช้ในการติดตั้งบันได');
                },
                child: Container(
                  height: 70,
                  width: double.infinity,
                    ...
                    child: Row(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            Text(
                              'ความสูงของอาคารที่ต้องใช้ในการติดตั้งบันได',
                              style: TextStyle(
                                  color: Color(0xff003175),
                                  fontWeight: FontWeight.w600,
                                  fontSize: 14),
