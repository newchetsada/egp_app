...
class uploadPicMounting extends StatefulWidget {
  ...
  final int status;
  uploadPicMounting(
      {required this.jidx, required this.type_id, required this.status});
}
                      ...
                      children: <Widget>[
                        ...
                        GridView.count(
                            ...
                            children: (widget.status == 3)
                                ...
                                : List.generate(desLs_before.length + 1,
                                    (index) {
                            ...
                            : Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  child: ElevatedButton(
                                    onPressed: () {
                                      loading();
                                      print(desLs_before.length);
                                      if (desLs_before.isEmpty ||
                                          _selectedValue == null ||
                                          detail == '') {
                                        Navigator.pop(context);
                                        pop('กรุณากรอกข้อมูลและอัพโหลดรูปก่อนซ่อม');
                                      } else {
