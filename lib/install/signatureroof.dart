...
class signatureroof extends StatefulWidget {
  @override
  _signatureroofState createState() => _signatureroofState();
...
class _signatureroofState extends State<signatureroof> {
  ...
  uploadPic(image) async {
    ...
    request.fields['problem'] = '';
    request.fields['solution'] = '';
    request.fields['signName'] = widget.signName;
