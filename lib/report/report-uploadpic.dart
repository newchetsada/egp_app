...
class ReportuploadPic extends StatefulWidget {
  @override
  _ReportuploadPicState createState() => _ReportuploadPicState();

  final int jidx;
  final int type_id;
  ReportuploadPic({required this.jidx, required this.type_id});
}

class _ReportuploadPicState extends State<ReportuploadPic> {
